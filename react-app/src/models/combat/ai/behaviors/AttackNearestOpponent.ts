 ...
 * - Mid-priority (lower than one-shot kills, higher than movement)
 * - Works with MoveTowardNearestOpponent for two-phase approach
 */
export class AttackNearestOpponent implements AIBehavior {
  readonly type = 'AttackNearestOpponent';
  readonly priority: number;
  readonly config?: unknown;
  readonly requiresMove = false;  // Attack from current position
